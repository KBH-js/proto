...
export const fontSize = {
  // Sub-xs steps for dense chrome (badges, tray captions, mono meta labels).
  // Tokenized so UI code never reaches for arbitrary `text-[10px]` values —
  // the `local/no-raw-px` lint rule blocks those.
